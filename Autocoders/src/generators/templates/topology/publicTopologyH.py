...
__CHEETAH_genTime__ = 1554930776.952485
__CHEETAH_genTimestamp__ = 'Wed Apr 10 14:12:56 2019'
__CHEETAH_src__ = 'publicTopologyH.tmpl'
...
class publicTopologyH(Template):
    ...
    def __init__(self, *args, **KWs):
        ...
        super(publicTopologyH, self).__init__(*args, **KWs)
...
void exitTasks(void) ;''')
    ...
    _mainCheetahMethod_for_publicTopologyH= 'respond'

## END CLASS DEFINITION

if not hasattr(publicTopologyH, '_initCheetahAttributes'):
    templateAPIClass = getattr(publicTopologyH, '_CHEETAH_templateClass', Template)
    templateAPIClass._addCheetahPlumbingCodeToClass(publicTopologyH)
...
if __name__ == '__main__':
    ...
    CmdLineIface(templateObj=publicTopologyH()).run()
