...
__CHEETAH_genTime__ = 1554930758.977877
__CHEETAH_genTimestamp__ = 'Wed Apr 10 14:12:38 2019'
__CHEETAH_src__ = 'includes2PortH.tmpl'
...
class includes2PortH(Template):
    ...
    def __init__(self, *args, **KWs):
        ...
        super(includes2PortH, self).__init__(*args, **KWs)
...
''')
    ...
    _mainCheetahMethod_for_includes2PortH= 'respond'

## END CLASS DEFINITION

if not hasattr(includes2PortH, '_initCheetahAttributes'):
    templateAPIClass = getattr(includes2PortH, '_CHEETAH_templateClass', Template)
    templateAPIClass._addCheetahPlumbingCodeToClass(includes2PortH)
...
if __name__ == '__main__':
    ...
    CmdLineIface(templateObj=includes2PortH()).run()
